...
function App() {
  ...
  const [groupedGenerativeResponse, setGroupedGenerativeResponse] =
    useState(null);
  const [groupedGenerativeIsLoading, setGroupedGenerativeIsLoading] =
    useState(false);
  const [singleGenerativeResponse, setSingleGenerativeResponse] =
    useState(null);
  const [singleGenerativeIsLoading, setSingleGenerativeIsLoading] =
    useState(false);
  ...
  return (
    <>
      <div className="container my-5">
        <div
          className="p-5 text-center rounded-3 border border-light rounded"
          style={{
        ...
        >
          <div className="container px-4 pt-5">
            ...
            <h4 className="text-secondary">
              Test your trivia knowledge with a 🤖 friend.
            </h4>
          </div>
          <div className="row row-cols-1 align-items-md-center g-5 pt-4 pb-2">
            <div
              className="col d-flex flex-column align-items-left gap-2"
        ...
        <div className="row row-cols-1 align-items-md-center g-5 py-2">
          <div className="col d-flex flex-column align-items-md-center gap-2">
            ...
            <SearchDisplay
              ...
              singleGenerativeIsLoading={singleGenerativeIsLoading}
            />
          </div>
        </div>
      </div>
      ...
      <div className="container px-4 pb-5">
        <small>
          Original questions from TV show <i>Jeopardy!</i>. Dataset from{" "}
          <a href="https://www.kaggle.com/datasets/tunguz/200000-jeopardy-questions">
            Kaggle
          </a>
          .
        </small>
